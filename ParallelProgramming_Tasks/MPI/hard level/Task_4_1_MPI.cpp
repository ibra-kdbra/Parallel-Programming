// The code is not mine, but I fixed it a little bit to make it work. 
It works poorly, but on the values in the file everything is fine. Therefore, the plan to scan it will work.
